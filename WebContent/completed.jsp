...
PreparedStatement pstmt=con.prepareStatement("Select * from complaint where status=?");
    ...
    <div class="sidebar-menu">
		    ...
		    <div class="menu">
		      <ul id="menu" >
		        ...
		        <li id="menu-comunicacao" ><a href="viewdeadline.jsp"><i class="fa fa-book nav_icon"></i><span>Deadline of road maintainance</span></a>
		
		        </li>
		          <li><a href="pending.jsp"><i class="fa fa-file-text"></i><span>Pending  task / complain</span></a></li>
		      </ul>
		    </div>
	 </div>
	<div class="clearfix"> </div>
