		    ...
		    <div class="menu">
		      <ul id="menu" >
		        <li id="menu-home" ><a href="index.html"><i class="fa fa-th-list"></i><span>Dashboard</span></a></li>
		         <li id="menu-home" ><a href="department.html"><i class="fa fa-th-list"></i><span>Add Department</span></a></li>
		          <li id="menu-home" ><a href="road.html"><i class="fa fa-th-list"></i><span>Add road maintenance</span></a></li>
		           <li id="menu-home" ><a href="helpline.html"><i class="fa fa-th-list"></i><span>Add helpline number</span></a></li>
